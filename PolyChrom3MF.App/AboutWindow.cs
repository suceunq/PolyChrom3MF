...
public sealed class AboutWindow : Window
{
    ...
    public AboutWindow()
    {
        Title = "À propos de PolyChrom 3MF"; Width = 560; Height = 390; ResizeMode = ResizeMode.NoResize; WindowStartupLocation = WindowStartupLocation.CenterOwner;
        ...
        panel.Children.Add(new TextBlock { Text = "Version 1.6.5", Foreground = (Brush)Application.Current.Resources["SecondaryText"], Margin = new Thickness(0, 2, 0, 18) });
        ...
        close.Click += (_, _) => Close(); panel.Children.Add(close); Content = panel;
    }
